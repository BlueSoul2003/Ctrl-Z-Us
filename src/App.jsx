...
const AdminDiscussions = React.lazy(() => import('./pages/AdminDiscussions.jsx'));
const AdminSessions = React.lazy(() => import('./pages/AdminSessions.jsx'));
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 flex flex-col">
      ...
      <main id="main" className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex-grow" tabIndex={-1}>
        <React.Suspense fallback={<div role="status" aria-live="polite" className="p-4">Loading…</div>}>
          <Routes>
            ...
            <Route path="/tutor" element={<ProtectedRoute allowedRoles={['tutor']}><TutorSessions user={currentUser} /></ProtectedRoute>} />
            ...
            <Route path="/admin/discussions" element={<ProtectedRoute allowedRoles={['admin']}><AdminDiscussions user={currentUser} /></ProtectedRoute>} />
            <Route path="/admin/sessions" element={<ProtectedRoute allowedRoles={['admin']}><AdminSessions user={currentUser} /></ProtectedRoute>} />
            <Route path="/admin/settings" element={<ProtectedRoute allowedRoles={['admin']}><AdminSettings user={currentUser} /></ProtectedRoute>} />
